...
**Stack:** React.js (Vite) · **Java 17 + Spring Boot 3** · MySQL · Spring Security + JWT · BCrypt · OpenPDF

This is the Spring Boot version of the app (same features and same React frontend as the Node/Express edition, with the backend fully rewritten in Java).
...
- Clean, responsive UI (unchanged from the Node.js edition) — works on mobile, tablet, and desktop.
